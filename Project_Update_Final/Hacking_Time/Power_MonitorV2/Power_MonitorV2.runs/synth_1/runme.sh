...
HD_PWD='Z:/Users/hiqbal/FPGA_HWSW/FPGA_AES_Accelerator/Hacking_Time/Power_MonitorV2/Power_MonitorV2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Power_Monitor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Power_Monitor.tcl
