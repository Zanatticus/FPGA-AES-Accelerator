...
HD_PWD='Z:/Users/hiqbal/FPGA_HWSW/FPGA_AES_Accelerator/Hacking_Time/Power_MonitorV2/Power_MonitorV2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Power_Monitor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Power_Monitor.tcl -notrace
