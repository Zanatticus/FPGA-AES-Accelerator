set moduleName aes_Pipeline_decryptedTextLoop
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes_Pipeline_decryptedTextLoop}
set C_modelType { void 0 }
set C_modelArgList {
	{ decryptedtext_array int 8 regular {array 16 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "decryptedtext_array", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ decryptedtext_array_address0 sc_out sc_lv 4 signal 0 } 
	{ decryptedtext_array_ce0 sc_out sc_logic 1 signal 0 } 
	{ decryptedtext_array_q0 sc_in sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "decryptedtext_array_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "decryptedtext_array", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	decryptedtext_array { ap_memory {  { decryptedtext_array_address0 mem_address 1 4 }  { decryptedtext_array_ce0 mem_ce 1 1 }  { decryptedtext_array_q0 in_data 0 8 } } }
