set moduleName aes_main_Pipeline_aesMainLoop
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes_main_Pipeline_aesMainLoop}
...
set portList { 
	...
	{ roundKey_address0 sc_out sc_lv 4 signal 0 } 
	...
	{ roundKey_address1 sc_out sc_lv 4 signal 0 } 
	...
	{ nbrRounds sc_in sc_lv 4 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "5"],
		...
		"Port" : [
			{"Name" : "roundKey", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_aes_round_fu_379", "Port" : "roundKey", "Inst_start_state" : "10", "Inst_end_state" : "37"}]},
			...
			{"Name" : "state", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_aes_round_fu_379", "Port" : "state", "Inst_start_state" : "10", "Inst_end_state" : "37"}]},
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_aes_round_fu_379", "Port" : "sbox", "Inst_start_state" : "10", "Inst_end_state" : "37"}]}],
		"Loop" : [
			{"Name" : "aesMainLoop", "PipelineType" : "NotSupport"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_round_fu_379", "Parent" : "0", "Child" : ["2", "3", "4"],
		"CDFG" : "aes_round",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "sbox", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_aes_round_fu_379.sbox_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_aes_round_fu_379.grp_galois_multiplication_fu_497", "Parent" : "1",
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_aes_round_fu_379.grp_galois_multiplication_fu_504", "Parent" : "1",
		"CDFG" : "galois_multiplication",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "335", "Max" : "483"}
	, {"Name" : "Interval", "Min" : "335", "Max" : "483"}
]}
