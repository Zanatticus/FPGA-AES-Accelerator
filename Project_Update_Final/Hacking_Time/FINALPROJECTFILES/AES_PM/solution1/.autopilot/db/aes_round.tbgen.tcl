...
set C_modelArgList {
	...
	{ roundKey int 8 regular {array 16 { 1 1 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_galois_multiplication_fu_497", "Parent" : "0",
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_galois_multiplication_fu_504", "Parent" : "0",
		"CDFG" : "galois_multiplication",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set Spec2ImplPortList { 
	...
	roundKey { ap_memory {  { roundKey_address0 mem_address 1 4 }  { roundKey_ce0 mem_ce 1 1 }  { roundKey_q0 mem_dout 0 8 }  { roundKey_address1 MemPortADDR2 1 4 }  { roundKey_ce1 MemPortCE2 1 1 }  { roundKey_q1 MemPortDOUT2 0 8 } } }
}
