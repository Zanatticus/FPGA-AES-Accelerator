...
set ID 114
set hasByteEnable 0
set MemName aes_aes_invRound_rsbox_ROM_2P_AUTO_1R
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename roundKey \
    op interface \
    ports { roundKey_address0 { O 4 vector } roundKey_ce0 { O 1 bit } roundKey_q0 { I 8 vector } roundKey_address1 { O 4 vector } roundKey_ce1 { O 1 bit } roundKey_q1 { I 8 vector } } \
} "
} else {
