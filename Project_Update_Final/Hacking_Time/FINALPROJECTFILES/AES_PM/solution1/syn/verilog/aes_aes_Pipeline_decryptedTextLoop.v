...
module aes_aes_Pipeline_decryptedTextLoop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [7:0] decryptedtext_array_q0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln97_fu_148_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln97_fu_148_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln97_fu_154_p2 = (ap_sig_allocacmp_i_13 + 5'd1);
...
assign ciphertext_and_decryptedtext_TDATA = decryptedtext_array_q0;
...
assign decryptedtext_array_address0 = i_23_cast_fu_160_p1;

assign i_23_cast_fu_160_p1 = ap_sig_allocacmp_i_13;

assign icmp_ln97_fu_148_p2 = ((ap_sig_allocacmp_i_13 == 5'd16) ? 1'b1 : 1'b0);

endmodule //aes_aes_Pipeline_decryptedTextLoop
