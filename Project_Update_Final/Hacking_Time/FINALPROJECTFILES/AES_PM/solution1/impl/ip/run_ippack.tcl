...
set xo_kernel_name "aes"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/iqbal.ha/AES_PM/solution1"
set debug_dir "C:/Users/iqbal.ha/AES_PM/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {aes_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    ...
    s_axi_control {
        ...
        registers {{0x10 mode W 0x0 "Data signal of mode" {{0 32 mode W 0 "Bit 31 to 0 of mode"}}} {0x18 enable_out W 0x0 "Data signal of enable_out" {{0 8 enable_out W 0 "Bit 7 to 0 of enable_out"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 power_reading_in W 0x0 "Data signal of power_reading_in" {{0 32 power_reading_in W 0 "Bit 31 to 0 of power_reading_in"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS s_axi_control key_and_plaintext ciphertext_and_decryptedtext"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    ciphertext_and_decryptedtext {
        type "axi4stream"
        mode "master"
        port_prefix "ciphertext_and_decryptedtext"
        has_tready "1"
        ports {
            TDATA 8
            TDEST 1
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 84 II x}
