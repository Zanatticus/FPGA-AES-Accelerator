...
module aes_aes_Pipeline_plaintextLoop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln76_fu_175_p2;
reg    ap_block_state1_pp0_stage0_iter0;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    key_and_plaintext_TDATA_blk_n;
wire   [63:0] i_17_cast_fu_187_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue_int == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start_int == 1'b0) | ((icmp_ln76_fu_175_p2 == 1'd0) & (key_and_plaintext_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_209)) begin
        if ((icmp_ln76_fu_175_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln76_fu_175_p2 == 1'd0) & (key_and_plaintext_TVALID == 1'b0))) & (icmp_ln76_fu_175_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b0) | ((icmp_ln76_fu_175_p2 == 1'd0) & (key_and_plaintext_TVALID == 1'b0)))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln76_fu_175_p2 == 1'd0) & (key_and_plaintext_TVALID == 1'b0))) & (icmp_ln76_fu_175_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln76_fu_175_p2 == 1'd0) & (key_and_plaintext_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done_int = 1'b1;
    end else begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln76_fu_175_p2 == 1'd0) & (key_and_plaintext_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_ready_int = 1'b1;
    end else begin
        ap_ready_int = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln76_fu_175_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln76_fu_181_p2 = (ap_sig_allocacmp_i_12 + 5'd1);

assign ap_CS_fsm_state1 = ap_CS_fsm[32'd0];

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_start_int == 1'b0) | ((icmp_ln76_fu_175_p2 == 1'd0) & (key_and_plaintext_TVALID == 1'b0)));
end

always @ (*) begin
    ap_condition_209 = (~((ap_start_int == 1'b0) | ((icmp_ln76_fu_175_p2 == 1'd0) & (key_and_plaintext_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1));
end

assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage0;

assign i_17_cast_fu_187_p1 = ap_sig_allocacmp_i_12;

assign icmp_ln76_fu_175_p2 = ((ap_sig_allocacmp_i_12 == 5'd16) ? 1'b1 : 1'b0);

assign p_4_0_0_0115_phi_out = tmp_k_and_p_last_V_fu_74;

assign plaintext_array_address0 = i_17_cast_fu_187_p1;
...
endmodule //aes_aes_Pipeline_plaintextLoop
