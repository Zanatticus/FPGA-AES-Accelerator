...
#
# Generated by export_simulation on Thu Apr 25 16:00:20 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './AES_PowerMon.sh' script.

./AES_PowerMon.sh -reset_run
...
./AES_PowerMon.sh -noclean_files

For more information on the script, please type './AES_PowerMon.sh -help'.
