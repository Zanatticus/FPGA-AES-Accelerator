...
HD_PWD='C:/Users/iqbal.ha/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_PowerMon_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_PowerMon_wrapper.tcl -notrace
