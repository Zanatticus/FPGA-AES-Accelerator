...
HD_PWD='C:/Users/iqbal.ha/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_PowerMon_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_PowerMon_wrapper.tcl
