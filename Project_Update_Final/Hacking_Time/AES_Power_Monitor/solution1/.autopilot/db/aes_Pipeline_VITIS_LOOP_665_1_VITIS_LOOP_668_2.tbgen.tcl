set moduleName aes_Pipeline_VITIS_LOOP_665_1_VITIS_LOOP_668_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes_Pipeline_VITIS_LOOP_665_1_VITIS_LOOP_668_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ ciphertext_array int 8 regular {array 16 { 1 3 } 1 1 }  }
	{ block_r int 8 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ciphertext_array", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "block_r", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ block_r_address0 sc_out sc_lv 4 signal 1 } 
	{ block_r_ce0 sc_out sc_logic 1 signal 1 } 
	{ block_r_we0 sc_out sc_logic 1 signal 1 } 
	{ block_r_d0 sc_out sc_lv 8 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	block_r { ap_memory {  { block_r_address0 mem_address 1 4 }  { block_r_ce0 mem_ce 1 1 }  { block_r_we0 mem_we 1 1 }  { block_r_d0 mem_din 1 8 } } }
}
