set moduleName aes_invMain_Pipeline_invShiftRowLoop
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes_invMain_Pipeline_invShiftRowLoop}
set C_modelType { void 0 }
set C_modelArgList {
	{ state_load_24 int 8 regular  }
	{ state_load_23 int 8 regular  }
	{ state_load_22 int 8 regular  }
	{ state_load_21 int 8 regular  }
	{ i_24 int 2 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "state_load_24", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "state_load_23", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "state_load_22", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "state_load_21", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "i_24", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ state_load_24 sc_in sc_lv 8 signal 0 } 
	{ state_load_23 sc_in sc_lv 8 signal 1 } 
	{ state_load_22 sc_in sc_lv 8 signal 2 } 
	{ state_load_21 sc_in sc_lv 8 signal 3 } 
	{ i_24 sc_in sc_lv 2 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "state_load_24", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "state_load_24", "role": "default" }} , 
 	{ "name": "state_load_23", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "state_load_23", "role": "default" }} , 
 	{ "name": "state_load_22", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "state_load_22", "role": "default" }} , 
 	{ "name": "state_load_21", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "state_load_21", "role": "default" }} , 
 	{ "name": "i_24", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "i_24", "role": "default" }} , 
...
set Spec2ImplPortList { 
	state_load_24 { ap_none {  { state_load_24 in_data 0 8 } } }
	state_load_23 { ap_none {  { state_load_23 in_data 0 8 } } }
	state_load_22 { ap_none {  { state_load_22 in_data 0 8 } } }
	state_load_21 { ap_none {  { state_load_21 in_data 0 8 } } }
	i_24 { ap_none {  { i_24 in_data 0 2 } } }
