...
set ID 135
set hasByteEnable 0
set MemName aes_key_array128_RAM_AUTO_1R1W
...
set ID 136
set hasByteEnable 0
set MemName aes_expandedKey_RAM_AUTO_1R1W
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 8
set AddrRange 240
...
set ID 137
set hasByteEnable 0
set MemName aes_block_RAM_AUTO_1R1W
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 16
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 138 \
			corename aes_CTRL_BUS_axilite \
			name aes_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler aes_CTRL_BUS_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 139 \
			corename aes_control_axilite \
			name aes_control_s_axi \
			ports {$port_control} \
			op interface \
			interrupt_clear_mode COR \
			interrupt_trigger_type default \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler aes_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { key_and_plaintext_TDATA { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { key_and_plaintext_TVALID { I 1 bit } key_and_plaintext_TREADY { O 1 bit } key_and_plaintext_TDEST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { ciphertext_and_decryptedtext_TDATA { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { ciphertext_and_decryptedtext_TVALID { O 1 bit } ciphertext_and_decryptedtext_TREADY { I 1 bit } ciphertext_and_decryptedtext_TDEST { O 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 154
set RegSliceName aes_regslice_both
set RegSliceInstName aes_regslice_both_U
set CoreName ap_simcore_aes_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
