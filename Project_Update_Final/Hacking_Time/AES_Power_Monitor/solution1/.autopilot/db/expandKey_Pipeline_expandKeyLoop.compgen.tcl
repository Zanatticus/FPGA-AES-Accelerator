...
set name aes_urem_8ns_6ns_5_12_1
...
set ID 36
set hasByteEnable 0
set MemName aes_expandKey_Pipeline_expandKeyLoop_sbox_ROM_AUTO_1R
...
set ID 37
set hasByteEnable 0
set MemName aes_expandKey_Pipeline_expandKeyLoop_Rcon_ROM_AUTO_1R
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 255
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { expandedKey_address0 { O 8 vector } expandedKey_ce0 { O 1 bit } expandedKey_we0 { O 1 bit } expandedKey_d0 { O 8 vector } expandedKey_q0 { I 8 vector } expandedKey_address1 { O 8 vector } expandedKey_ce1 { O 1 bit } expandedKey_q1 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_size_cast \
    op interface \
    ports { size_cast { I 6 vector } } \
} "
}
