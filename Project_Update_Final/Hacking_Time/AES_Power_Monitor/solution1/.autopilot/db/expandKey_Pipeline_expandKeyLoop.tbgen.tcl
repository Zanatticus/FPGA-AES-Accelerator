set moduleName expandKey_Pipeline_expandKeyLoop
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {expandKey_Pipeline_expandKeyLoop}
set C_modelType { void 0 }
set C_modelArgList {
	{ size_cast int 6 regular  }
	{ expandedKeySize int 8 regular  }
	{ expandedKey int 8 regular {array 240 { 2 1 } 1 1 }  }
	{ cmp17 int 1 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "size_cast", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ size_cast sc_in sc_lv 6 signal 0 } 
	{ expandedKeySize sc_in sc_lv 8 signal 1 } 
	{ expandedKey_address0 sc_out sc_lv 8 signal 2 } 
	{ expandedKey_ce0 sc_out sc_logic 1 signal 2 } 
	{ expandedKey_we0 sc_out sc_logic 1 signal 2 } 
	{ expandedKey_d0 sc_out sc_lv 8 signal 2 } 
	{ expandedKey_q0 sc_in sc_lv 8 signal 2 } 
	{ expandedKey_address1 sc_out sc_lv 8 signal 2 } 
	{ expandedKey_ce1 sc_out sc_logic 1 signal 2 } 
	{ expandedKey_q1 sc_in sc_lv 8 signal 2 } 
	{ cmp17 sc_in sc_lv 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "size_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "size_cast", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_8ns_6ns_5_12_1_U34", "Parent" : "0"},
...
set Spec2ImplPortList { 
	size_cast { ap_none {  { size_cast in_data 0 6 } } }
	expandedKeySize { ap_none {  { expandedKeySize in_data 0 8 } } }
	expandedKey { ap_memory {  { expandedKey_address0 mem_address 1 8 }  { expandedKey_ce0 mem_ce 1 1 }  { expandedKey_we0 mem_we 1 1 }  { expandedKey_d0 mem_din 1 8 }  { expandedKey_q0 in_data 0 8 }  { expandedKey_address1 MemPortADDR2 1 8 }  { expandedKey_ce1 MemPortCE2 1 1 }  { expandedKey_q1 MemPortDOUT2 0 8 } } }
