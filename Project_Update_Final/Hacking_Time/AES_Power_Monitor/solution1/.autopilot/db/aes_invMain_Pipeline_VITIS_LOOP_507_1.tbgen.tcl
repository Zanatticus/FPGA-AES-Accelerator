set moduleName aes_invMain_Pipeline_VITIS_LOOP_507_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes_invMain_Pipeline_VITIS_LOOP_507_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ state int 8 regular {array 16 { 0 1 } 1 1 }  }
	{ rsbox int 8 regular {array 256 { 1 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "state", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "rsbox", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ rsbox_address0 sc_out sc_lv 8 signal 1 } 
	{ rsbox_ce0 sc_out sc_logic 1 signal 1 } 
	{ rsbox_q0 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rsbox_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rsbox", "role": "address0" }} , 
 	{ "name": "rsbox_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rsbox", "role": "ce0" }} , 
 	{ "name": "rsbox_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rsbox", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	state { ap_memory {  { state_address0 mem_address 1 4 }  { state_ce0 mem_ce 1 1 }  { state_we0 mem_we 1 1 }  { state_d0 mem_din 1 8 }  { state_address1 MemPortADDR2 1 4 }  { state_ce1 MemPortCE2 1 1 }  { state_q1 in_data 0 8 } } }
	rsbox { ap_memory {  { rsbox_address0 mem_address 1 8 }  { rsbox_ce0 mem_ce 1 1 }  { rsbox_q0 in_data 0 8 } } }
}
