...
entity aes_aes_Pipeline_VITIS_LOOP_94_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of aes_aes_Pipeline_VITIS_LOOP_94_5 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln94_fu_148_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_35_cast_fu_160_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln94_fu_148_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_66 <= add_ln94_fu_154_p2;
    ...
    add_ln94_fu_154_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_29) + unsigned(ap_const_lv5_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln94_fu_148_p2)
    begin
        if (((icmp_ln94_fu_148_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_i_29_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_fu_66, ap_loop_init)
    begin
    ...
    ciphertext_and_decryptedtext_TDATA <= decryptedtext_array_q0;
    ...
    decryptedtext_array_address0 <= i_35_cast_fu_160_p1(4 - 1 downto 0);

    decryptedtext_array_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
    ...
    i_35_cast_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_29),64));
    icmp_ln94_fu_148_p2 <= "1" when (ap_sig_allocacmp_i_29 = ap_const_lv5_10) else "0";
end behav;
