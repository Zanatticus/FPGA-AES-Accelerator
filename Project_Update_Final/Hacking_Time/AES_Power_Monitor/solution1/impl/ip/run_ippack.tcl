...
set solution_dir "Z:/Users/hiqbal/AES_Power_Monitor/solution1"
set debug_dir "Z:/Users/hiqbal/AES_Power_Monitor/solution1/.debug"
...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x10 mode W 0x0 "Data signal of mode" {{0 32 mode W 0 "Bit 31 to 0 of mode"}}} {0x18 enable_in W 0x0 "Data signal of enable_in" {{0 8 enable_in W 0 "Bit 7 to 0 of enable_in"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 power_reading_out W 0x0 "Data signal of power_reading_out" {{0 32 power_reading_out W 0 "Bit 31 to 0 of power_reading_out"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    s_axi_control {
        ...
        registers {{0x10 enable_out W 0x0 "Data signal of enable_out" {{0 8 enable_out W 0 "Bit 7 to 0 of enable_out"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 power_reading_in W 0x0 "Data signal of power_reading_in" {{0 32 power_reading_in W 0 "Bit 31 to 0 of power_reading_in"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
